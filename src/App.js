              ...
              <li>
                ...
                <div className="collapsible-body">
                  <ul>
                    ...
                    <li>
                      <a href="home-page-3-carousel.html" className="waves-effect">
              ...
              <li>
                ...
                <div className="collapsible-body">
                  <ul>
                    ...
                    <li>
                      <a href="blog-post-left-column.html" className="waves-effect">
                    ...
                    <li>
                      <a href="blog-post-full-width.html" className="waves-effect">
              ...
              <li>
                ...
                <div className="collapsible-body">
                  <ul>
                    ...
                    <li>
                      <a href="category-right-column.html" className="waves-effect">
